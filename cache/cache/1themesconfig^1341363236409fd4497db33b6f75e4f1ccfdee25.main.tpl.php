...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_556c1949effce5_58971301',
  'has_nocache_code' => true,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_556c1949effce5_58971301')) {function content_556c1949effce5_58971301($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_function_L')) include 'C:\\WebServ\\httpd\\windu/data/functions\\function.L.php';
?><!DOCTYPE html>
<html>
	<head>
	    ...
	    <div id="leftMenuThemes" class="accordion-body collapse in">
      		<div class="accordion-inner">	
				<ul>
				    ...
				    <li class="active"><a href="http://localhost/windu/admin/themes/config/"><i class="color-icons icons-gear icon-margin"> </i><span class="menu-description">Konfiguracja</span></a></li>				</ul>	
			</div>
		</div>			
	</li>
			<li class="accordion-group ">
